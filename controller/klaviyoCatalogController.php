...
class klaviyoCatalogController extends Controller {
    ...
    public function __construct()
    {
        ...
        $this->klaviyoCatalogController();

    }

    public function klaviyoCatalogController() {
    ...
    public function generateCatalog() {
        ...
        foreach ($courses as $course) {
            ...
            $sale_price = $this->getSalePrice($course->price);
            ...
            $item->add('g:id', $item_id)
                ...
                ->add('g:condition', 'new')
                ->add('g:categories', $imploded_cats);
        ...
        foreach($subs as $sub) {
            ...
            $item->add('g:id', $item_id)
                ...
                ->add('g:brand', 'New Skills Academy')
                ->add('g:condition', 'new')
                ->add('g:categories', 'Subscription Plans');
        ...
        $rss->save('assets/cdn/klaviyo-catalog.xml', true);
        ...
        foreach($currencies as $currency) {
            ...
            */
            ...
            foreach ($courses as $course) {
                ...
                $course_image = $course_controller->getCourseImage($course->id);
                $course_price = $this->getCoursePrice($course, $currency->id);
                $sale_price = $this->getSalePrice($course_price, $currency->id);
                $availability = $course->hidden == '1' ? 'out of stock' : 'in stock';
            ...
            $rss->save('assets/cdn/klaviyo-catalog-'.$currency->code.'.xml', true);
    ...
    public function generateCatalogAllCurrenciesDynamic() {
        ...
        foreach($currencies as $currency) {
            ...
            */
            ...
            $rss->save('assets/cdn/klaviyo-catalog-'.$currency->code.'-dynamic-refs.xml', true);
