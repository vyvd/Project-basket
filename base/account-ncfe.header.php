...
<nav class="navbar navbar-expand-lg sidenav navbar-vertical">
    ...
    <div class="collapse navbar-collapse" id="navBar">
        <ul class="nav navbar-nav ml-auto">
            <li class="nav-item link <?php if(REQUEST == "dashboard/ncfe") { ?>active<?php } ?>">
                <a class="nav-link" href="<?= SITE_URL ?>dashboard/ncfe">
                    <span class="icon"><i class="fas fa-tachometer-alt"></i></span>
                    <span class="menu-title">Dashboard</span>
                </a>
            </li>
            <li class="nav-item link <?php if(REQUEST == "dashboard/ncfe/courses") { ?>active<?php } ?>">
                <a class="nav-link" href="<?= SITE_URL ?>dashboard/ncfe/courses">
                    <span class="icon"><i class="fas fa-graduation-cap"></i></span>
                    <span class="menu-title">My Courses</span>
                </a>
            </li>
            <li class="nav-item link <?php if(REQUEST == "dashboard/ncfe/assignments") { ?>active<?php } ?>">
                <a class="nav-link" href="<?= SITE_URL ?>dashboard/ncfe/assignments">
                    <span class="icon"><i class="fas fa-school"></i></span>
                    <span class="menu-title">Assignments</span>
                </a>
            </li>
            <li class="nav-item link <?php if(REQUEST == "dashboard/ncfe/documents") { ?>active<?php } ?>">
                <a class="nav-link" href="<?= SITE_URL ?>dashboard/ncfe/documents">
                    <span class="icon"><i class="fas fa-folder"></i></span>
                    <span class="menu-title">Documents</span>
                </a>
            </li>
            <li class="nav-item link <?php if(REQUEST == "dashboard/ncfe/messages") { ?>active<?php } ?>">
                <a class="nav-link" href="<?= SITE_URL ?>dashboard/ncfe/messages">
                    <span class="icon"><i class="fas fa-envelope"></i></span>
                    <span class="menu-title">Messages (<?= ORM::for_table("messages")->where("recipientID", CUR_ID_FRONT)->where("seen", "0")->count(); ?>)</span>
                </a>
            </li>
            <li class="nav-item link <?php if(REQUEST == "dashboard/ncfe/certificates") { ?>active<?php } ?>">
                <a class="nav-link" href="<?= SITE_URL ?>dashboard/ncfe/certificates">
                    <span class="icon"><i class="fas fa-chalkboard"></i></span>
                    <span class="menu-title">My Certificates</span>
                </a>
            </li>
            <li class="nav-item link <?php if(REQUEST == "dashboard/ncfe/rewards") { ?>active<?php } ?>">
                <a class="nav-link" href="<?= SITE_URL ?>dashboard/ncfe/rewards">
