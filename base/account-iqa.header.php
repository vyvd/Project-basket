...
<nav class="navbar navbar-expand-lg sidenav navbar-vertical">
    ...
    <div class="collapse navbar-collapse" id="navBar">
        <ul class="nav navbar-nav ml-auto">
            <li class="nav-item link <?php if(REQUEST == "dashboard/iqa") { ?>active<?php } ?>">
                <a class="nav-link" href="<?= SITE_URL ?>dashboard/iqa">
                    <span class="icon"><i class="fas fa-tachometer-alt"></i></span>
                    <span class="menu-title">Dashboard</span>
                </a>
            </li>
            <li class="nav-item link <?php if(REQUEST == "dashboard/iqa/students") { ?>active<?php } ?>">
                <a class="nav-link" href="<?= SITE_URL ?>dashboard/iqa/students">
                    <span class="icon"><i class="fas fa-users"></i></span>
                    <span class="menu-title">Students</span>
                </a>
            </li>
            <li class="nav-item link <?php if(REQUEST == "dashboard/iqa/assignments") { ?>active<?php } ?>">
                <a class="nav-link" href="<?= SITE_URL ?>dashboard/iqa/assignments">
                    <span class="icon"><i class="fas fa-school"></i></span>
                    <span class="menu-title">Assignments</span>
                </a>
            </li>
            <li class="nav-item link <?php if(REQUEST == "dashboard/iqa/tutors") { ?>active<?php } ?>">
                <a class="nav-link" href="<?= SITE_URL ?>dashboard/iqa/tutors">
