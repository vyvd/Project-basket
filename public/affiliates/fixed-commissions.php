						...
						<div class="panel">
							...
							<div class="panel-content">
								...
								<form action="data/set-default-commission" method="post">
									Default Commission <input type="text" name="dc" value="<?php default_commission();?>" placeholder="10" disabled/>%
									<input type="submit" name="submit" value="Set" class="btn btn-success" disabled/>
								</form>
								<hr>
