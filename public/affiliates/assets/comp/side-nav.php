...
<li class="side-danger menu-item <?php if($page=='affiliates-reports.php'){echo 'active';}?>">
	<a href="http://<?php echo $domain_path;?>/affiliates-reports">
		<i class="fa-file-pdf"></i> Affiliate Reports
	</a>
</li>
...
<li class="side-danger menu-item <?php if($page=='banners-iframe.php'){echo 'active';}?>">
	<a href="http://<?php echo $domain_path;?>/banners-iframe">
		<i class="fa-picture"></i> Iframe Generator
	</a>
</li>
...
<li class="side-danger menu-item <?php if($page=='my-reports.php'){echo 'active';}?>">
	<a href="http://<?php echo $domain_path;?>/my-reports">
		<i class="fa-file-pdf"></i> Reports
	</a>
</li>
<?php if(isset($_SESSION['token']) && $_SESSION['token'] == 'dmswitchme2017') { ?>
<li class="side-danger menu-item <?php if($page=='settings.php'){echo 'active';}?>">
	<?php
		$admin_affiliate_id = 3;
		$email = 'dan@themorgans.co.uk';
		$token = $_SESSION['token'];
	?>
	<a href="http://<?php echo $domain_path;?>/access/process_login.php?a=<?php echo $admin_affiliate_id ?>email=<?php echo $email ?>&token=<?php echo $token ?>">
		<i class="fa-cog"></i> SWITCH BACK
	</a>
</li>
<?php } ?>
<?php } ?>