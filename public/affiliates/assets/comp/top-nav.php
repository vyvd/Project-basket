<nav class="navbar navbar-default navbar-fixed-top">
		<!-- Logo -->
		<div class="logo">
			<a href="dashboard"> <img src="//<?php echo $domain_path;?>/assets/img/aplogo2.png" width="87" height="38">
			</a>
		</div>
		<!-- End Logo -->
		<div id="navbar">
					  ...
					  <div class="controls">
						  <form method="post" action="lang/change-currency.php" style="margin-left:5px;">
							  ...
							  <select onchange="this.form.submit()" name="selected_currency" class="input-large">
								  <option value="en-US" <?php if($locale=='en-US'){echo 'selected="selected"';}?>>USD</option>
									<option value="en-GB" <?php if($locale=='en-GB'){echo 'selected="selected"';}?>>GBP</option>
								  <option value="en-IN" <?php if($locale=='en-IN'){echo 'selected="selected"';}?>>INR</option>
								  <option value="de-DE" <?php if($locale=='de-DE'){echo 'selected="selected"';}?>>EUR</option>
								  <option value="ja_JP" <?php if($locale=='ja_JP'){echo 'selected="selected"';}?>>JPY</option>
									<option value="ru_RU" <?php if($locale=='ru_RU'){echo 'selected="selected"';}?>>RUR</option>
								</select>
								</div>
						  </form>
					  </div>
   ...
   <div class="loading-ns" style="display: none;">
		<div class="center-it">
			...
			<span>Please wait a moment loading...</span>
		</div>
	</div>