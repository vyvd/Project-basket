<?php $cpc_on = cpc_on();
$comission_override = get_affiliate_type_comission($owner);
	...
	<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
		<div class="stat-box">
			<a href="my-traffic">
				...
				<div class="stat-data">
					<h2><?php echo $comission_override->comission ?>% <span class="stat-info">Current Comission Percentage</span></h2>
				</div>
			</a>
		</div>
	</div>
