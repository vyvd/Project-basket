									...
									<thead>
										<tr>
											...
											<?php
                                                ...
                                                $data_table_columns = [ 0, 1, 2, 3, 4, 5 ];
												$rc_on = rc_on(); if($rc_on=='1'){
                                                $data_table_order_by_column_index = 6;
                                                $data_table_columns = [ 0, 1, 2, 3, 4, 5, 6 ];
	...
	$(document).ready(function() {
		...
		function fetch_data(is_date_search, start_date = '', end_date = '') {
		   	var datatable = $('#sales').DataTable({
		        	...
		        	"ajax": {
		        		"url": "<?php echo $protocol.$_SERVER['HTTP_HOST'] ?>/affiliates/data/ajax-my-sales.php",
		        		"type": "GET",
		        		"data": {
			        ...
			        buttons: [
			            {
			                ...
			                exportOptions: {
			                    ...
			                    columns: <?php echo $data_table_columns; ?>
			                },
			                title: 'IPs',
			        	},
			            {
		...
		function fetch_meta_boxes(start_date, end_date) {
			$.ajax({
				type: "POST",
				url: "<?php echo $protocol.$_SERVER['HTTP_HOST'] ?>/affiliates/data/ajax-my-sales-mb.php",
				dataType: "json",
				data: {
