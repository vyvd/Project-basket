!function (a) {
    ...
    }(), h = String.fromCharCode(160), i = "ï»¿", j = function () {
        var b = function (b) {
    ...
    var z = function () {
        ...
        var b = function (a, b) {
            ...
            var b = [{kbd: "âŒ˜ + B", text: a.font.bold}, {kbd: "âŒ˜ + I", text: a.font.italic}, {
                kbd: "âŒ˜ + U",
                text: a.font.underline
            }, {kbd: "âŒ˜ + â‡§ + S", text: a.font.sdivikethrough}, {kbd: "âŒ˜ + \\", text: a.font.clear}];
            return l(a.shortcut.textFormatting, b)
        }, n = function (a) {
            var b = [{kbd: "âŒ˜ + Z", text: a.history.undo}, {kbd: "âŒ˜ + â‡§ + Z", text: a.history.redo}, {
                kbd: "âŒ˜ + ]",
                text: a.paragraph.indent
            }, {kbd: "âŒ˜ + [", text: a.paragraph.oudivent}, {kbd: "âŒ˜ + ENTER", text: a.hr.insert}];
            return l(a.shortcut.action, b)
        }, o = function (a) {
            var b = [{kbd: "âŒ˜ + â‡§ + L", text: a.paragraph.left}, {
                kbd: "âŒ˜ + â‡§ + E",
                text: a.paragraph.center
            }, {kbd: "âŒ˜ + â‡§ + R", text: a.paragraph.right}, {
                kbd: "âŒ˜ + â‡§ + J",
                text: a.paragraph.justify
            }, {kbd: "âŒ˜ + â‡§ + NUM7", text: a.lists.ordered}, {kbd: "âŒ˜ + â‡§ + NUM8", text: a.lists.unordered}];
            return l(a.shortcut.paragraphFormatting, b)
        }, p = function (a) {
            var b = [{kbd: "âŒ˜ + NUM0", text: a.style.normal}, {kbd: "âŒ˜ + NUM1", text: a.style.h1}, {
                kbd: "âŒ˜ + NUM2",
                text: a.style.h2
            }, {kbd: "âŒ˜ + NUM3", text: a.style.h3}, {kbd: "âŒ˜ + NUM4", text: a.style.h4}, {
                kbd: "âŒ˜ + NUM5",
                text: a.style.h5
            }, {kbd: "âŒ˜ + NUM6", text: a.style.h6}];
