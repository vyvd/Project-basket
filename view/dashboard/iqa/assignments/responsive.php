                    ...
                    <div class="col-12 col-md-12 col-lg-12">
                        ...
                        <div class="white-rounded" style="padding:20px;">
                            <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                                ...
                                <tbody>
                                <?php
                                $tutors = ORM::for_table("accounts")->where("isTutor", "1")->find_many();

                                foreach($tutors as $tutor) {

                                    $students = ORM::for_table("accounts")->where("tutorID", $tutor->id)->find_many();
                                    foreach($students as $account) {
                                        ...
                                        foreach($items as $item) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="<?= SITE_URL ?>dashboard/tutor/student/<?= $account->id ?>" class="label label-system" style="width: 140px;" target="_blank">
                                                        See More
                                                    </a>
                                                </td>
                                            </tr>
