<?php
$css = array("dashboard.css", "animate.min.css", "landing-user.css");
$this->setControllers(array("course"));
$pageTitle = "Subscribe To Unlimited Learning";
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-12 regular-full">
                    <div class="container white-rounded" style="padding:0;">
                                ...
                                <div class="container wider-container">
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-lg-7">
                                            ...
                                            <h2 class="wow fadeInUp">Become an Unlimited Learning Member & get</h2>
                                            ...
                                            <a href="<?= SITE_URL ?>checkout?addSub=true&plan=1" class="cta wow pulse" data-wow-delay="3s">
                                                    Just <?= $this->price($currency->prem1) ?> per month
                                                </a>
                                            ...
                                            <a href="<?= SITE_URL ?>checkout?addSub=true" class="cta wow pulse" data-wow-delay="3s">
                                                Just <?= $this->price($currency->prem12) ?> per year
                                            </a>
                            ...
                            if($currency->code == "GBP") {
                                    ...
                                    <div class="container wider-container">
                                        <div class="row">
                                            <div class="col-12 col-lg-8">
                                                <h4>Start your Unlimited Learning membership today for only <?= $this->price($currency->prem1) ?> p/m</h4>
                                ...
                                <section class="cta sticky">
                                    <div class="container wider-container">
                                        <div class="row">
                                            <div class="col-12 col-lg-8">
                                                <h4>Start your Unlimited Learning membership today for only <?= $this->price($currency->prem12) ?> p/y</h4>
                                                <p>& get access to our entire course catalogue and exclusive benefits</p>
                                            </div>
                                            <div class="col-12 col-lg-4">
                                                <a href="<?= SITE_URL ?>checkout?addSub=true">
                                                    Let's Do It!
                                                </a>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row ">
                                            <div class="col-md-4 text-center student">
                                                ...
                                                <div class=" mt-5 students-cont">
                                                    <img src="https://rebuild.newskillsacademy.co.uk/assets/images/Amy-Hewson.png" style="border-radius: 50%;width: 65px;margin-bottom: 15px;" alt="">
                                                    <h5>Amy Hewson</h5>
                                                </div>
                                            </div>
                                            <div class="col-md-4 text-center student">
                                                ...
                                                <div class=" mt-5 students-cont">
                                                    <img src="https://rebuild.newskillsacademy.co.uk/assets/images/Ryan-Knight.png" style="border-radius: 50%;width: 65px;margin-bottom: 15px;" alt="">
                                                    <h5>Ryan Knight</h5>
                                                </div>
                                            </div>
                                            <div class="col-md-4 text-center student">
                                                ...
                                                <div class="mt-5 students-cont">
                                                    <img src="https://rebuild.newskillsacademy.co.uk/assets/images/Natalie-Rogerson.png" style="border-radius: 50%;width: 65px;margin-bottom: 15px;" alt="">
