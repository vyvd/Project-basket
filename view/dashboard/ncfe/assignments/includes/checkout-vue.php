...
<script>
    var app = new Vue({
        ...
        data: {
            ...
            updateCartItemUrl: '',
            paymentType: 'stripe',
            orderCompleteUrl : '<?= SITE_URL ?>dashboard/ncfe/assignments?tab=checkout&payment=success',
            paymentSuccessUrl : '<?= SITE_URL ?>dashboard/ncfe/thankyou',
            paymentFailedUrl : '<?= SITE_URL ?>dashboard/ncfe/assignments?tab=checkout&payment=failed',
        ...
        methods: {
            getCartItems: function (e){
                ...
                $.ajax({
                    ...
                    success: function(response){
                        ...
                        that.cartItems = response.cartItems;
            ...
            removeFromCart: function (id, event) {
                ...
                const url = "<?= SITE_URL ?>ajax?c=cart&a=removeAssessmentItem&action=json&id="+id;
                    ...
                    if(response.error){
                        if(response.requires_action === true){
                            ...
                            stripe.confirmCardPayment(response.payment_intent_client_secret).then(function(result) {
                                if(result.error) {
                                    window.location.href = that.paymentFailedUrl;
                                    ...
                                    $.ajax({
                                        ...
                                        window.location.href = that.paymentSuccessUrl;
                                    });
                                }else{
                                    window.location.href = that.paymentFailedUrl;
                                }
                        ...
                        $.ajax({
                            ...
                            window.location.href = this.paymentSuccessUrl
                        });
                    }else{
                        window.location.href = this.paymentFailedUrl;
                    }
