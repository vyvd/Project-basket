    ...
    <main role="main" class="regular">
                ...
                <div class="p-3 " style="border-radius: 10px;">
                    <div class="row ">
                        <div class="col-md-5 text-left">
                            <div class="col-md-6 .sub_sec_title_inner ">
                                <div class="sub_sec_title_outer show-desktop">
                                    <label><img src="<?= SITE_URL ?>assets/images/xo_sub.png"></label>
                                </div>
                                <div class="sub_sec_title_outer show-mobile">
                                    <label><img src="<?= SITE_URL ?>assets/images/xo-b.png"></label>
                                </div>
                            </div>
        ...
        <section class="question-learning_cv_builder">
            <div class="container learn-container text-center">
                <div class="p-3 pb-5" style="border-radius: 10px;">
                    <div class="row">
                        <div class="col-md-6 order-md-first">
                            <div class="col_outer">
                                <div class="col_inner">
                                    <img src="<?= SITE_URL ?>assets/images/cv.png">
                                    <p>Free access to our award-winning AI-powered CV builder and
                        ...
                        <div class="col-md-6 order-first ">
                            ...
                            <h3 class="column-title ml-md-3 mt-5">
                                <u>Our CV Builder</u> <br>
                ...
                <div class="p-3 pb-5" style="border-radius: 10px;">
                    <div class="row">
                        ...
                        <div class="col-md-6 order-first">
                            ...
                            <h3 class="column-title w-100 mt-5 pl-md-5">
                                <u>Our learning community</u> <br>
                                Chat with 1000's of fellow students
                            </h3>
                            <h5 class="pl-md-5 text-left">Get advice, share your opinions and meet like-minded students
                                in our
                    ...
                    <div class="col-md-8 mt-5">
                        <div class="accordion" id="accordionFaqs">
                            ...
                            foreach ($questions as $question) {
                                ...
                                $question->answer = str_replace("700 courses", $courseCount." courses", $question->answer);

                                if($currency->code != "GBP") {
                                    $question->answer = str_replace("In addition you will receive an XO Student Discounts Digital membership (rrp &pound;10) for as long as you are a member", "", $question->answer);
                                }
