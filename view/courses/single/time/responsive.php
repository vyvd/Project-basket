                    ...
                    <div id="single-course-body">
                        ...
                        <div class="accordion" id="accordionModules">
                            ...
                            foreach($this->controller->courseModules($course) as $module) {
                                ?>
                                <div class="card">
                                    <div class="card-header active" id="heading<?= $module->id ?>">
                                        <h2 class="mb-0">
                                    ...
                                    <div id="collapse<?= $module->id ?>" class="collapse show" aria-labelledby="heading<?= $module->id ?>" data-parent="#accordionModules">
                                        <div class="card-body">
                                            <?= $module->estTime ?>
                                            Minute<?php if($module->estTime != "1") { ?>s<?php } ?>
                                        </div>
                                    </div>
                                </div>
                                <?php
