    ...
    <div class="chute chute-center">
        ...
        <div class="panel" id="spy2">
            <div class="panel-heading">
                <span class="panel-title">Affiliate FAQs</span>
            ...
            <div class="panel-body pn">
                <div class="table-responsive">
                    <table class="table footable" data-filter="#fooFilter" data-page-navigation=".pagination" data-page-size="50">
                        ...
                        <tbody>
                        <?php
                        $items = ORM::for_table("affiliateFaqs")->order_by_desc("whenAdded")->find_many();
                        ...
                        foreach($items as $item) {
                            ...
                            <tr id="item<?= $item->id ?>">
                                ...
                                <td>
                                    <a href="<?= SITE_URL ?>blume/content/affiliate-faqs/edit?id=<?= $item->id ?>" class="label label-warning">
...
<script type="text/javascript">
    function deleteItem(id) {
        if (window.confirm("Are you sure you want to delete this item?")) {
            $("#deleteProduct").load("<?= SITE_URL ?>ajax?c=blumeNew&a=delete-affiliate-faq&id="+id);
            $("#item"+id).fadeOut();
        }
    }
</script>
...
<script type="text/javascript">
    jQuery("form[name='addNewItem']").submit(function(e) {
        ...
        jQuery.ajax({
            url: "<?= SITE_URL ?>ajax?c=blumeNew&a=create-affiliate-faq",
            type: "POST",
            data: formData,
            async: true,
