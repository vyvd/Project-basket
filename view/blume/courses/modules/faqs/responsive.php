    ...
    <div class="chute chute-center">
        ...
        <div class="panel" id="spy2">
            <div class="panel-heading">
                <span class="panel-title">Course Module FAQs</span>
            ...
            <div class="panel-body pn">
                <div class="table-responsive">
                    <table class="table footable" data-filter="#fooFilter" data-page-navigation=".pagination" data-page-size="50">
                        ...
                        <tbody>
                        <?php
                        $items = ORM::for_table("courseModuleFaqs")->order_by_asc("id")->find_many();
                        ...
                        foreach($items as $item) {
                            ...
                            <tr id="item<?= $item->id ?>">
                                ...
                                <td>
                                    <a href="<?= SITE_URL ?>blume/courses/modules/faqs/edit?id=<?= $item->id ?>" class="label label-warning">
...
<script type="text/javascript">
    function deleteItem(id) {
        if (window.confirm("Are you sure you want to delete this item?")) {
            $("#deleteProduct").load("<?= SITE_URL ?>ajax?c=blumeNew&a=delete-course-module-faq&id="+id);
            $("#item"+id).fadeOut();
        }
    }
</script>
        ...
        <div class="modal-content">
            ...
            <form name="addNewItem">
                <div class="modal-body">
                    ...
                    <p><em>You'll be prompted to add answer content next.</em></p>
...
<script type="text/javascript">
    jQuery("form[name='addNewItem']").submit(function(e) {
        ...
        jQuery.ajax({
            url: "<?= SITE_URL ?>ajax?c=blumeNew&a=create-course-module-faq",
            type: "POST",
            data: formData,
            async: true,
