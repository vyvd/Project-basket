            ...
            <div class="panel-body pn">
                <div class="table-responsive">
                    <table class="table footable" data-filter="#fooFilter" data-page-navigation=".pagination" data-page-size="50">
                        ...
                        <tbody>
                        <?php
                        $items = ORM::for_table("blog")->order_by_desc("whenAdded")->find_many();
                        ...
                        foreach($items as $item) {
                            ...
                            <tr id="item<?= $item->id ?>">
                                ...
                                <td>
                                    <a href="<?= SITE_URL ?>blume/support/blog/edit?id=<?= $item->id ?>" class="label label-warning">
...
<script type="text/javascript">
    function deleteItem(id) {
        if (window.confirm("Are you sure you want to delete this item?")) {
            $("#deleteProduct").load("<?= SITE_URL ?>ajax?c=blumeNew&a=delete-blog&id="+id);
            $("#item"+id).fadeOut();
        }
    }
</script>
        ...
        <div class="modal-content">
            ...
            <form name="addNewItem">
                <div class="modal-body">
                    ...
                    <p><em>You will be redirected to add content to this blog post.</em></p>
...
<script type="text/javascript">
    jQuery("form[name='addNewItem']").submit(function(e) {
        ...
        jQuery.ajax({
            url: "<?= SITE_URL ?>ajax?c=blumeNew&a=create-blog",
            type: "POST",
            data: formData,
            async: true,
