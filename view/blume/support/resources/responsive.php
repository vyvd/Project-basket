            ...
            <div class="panel-body pn">
                <div class="table-responsive">
                    <table class="table footable" data-filter="#fooFilter" data-page-navigation=".pagination" data-page-size="50">
                        ...
                        <tbody>
                        <?php
                        $items = ORM::for_table("resources")->order_by_desc("whenAdded")->find_many();
                        ...
                        foreach($items as $item) {
                            ...
                            <tr id="item<?= $item->id ?>">
                                ...
                                <td>
                                    <a href="<?= SITE_URL ?>blume/support/resources/edit?id=<?= $item->id ?>" class="label label-warning">
                                        <i class="fa fa-edit"></i>
                                    </a>
                                    <a href="<?= SITE_URL ?>support/resources/<?= $item->slug ?>" class="label label-info" target="_blank" style="margin-left:5px;cursor:pointer;">
...
<script type="text/javascript">
    function deleteItem(id) {
        if (window.confirm("Are you sure you want to delete this item?")) {
            $("#deleteProduct").load("<?= SITE_URL ?>ajax?c=blumeNew&a=delete-resource&id="+id);
            $("#item"+id).fadeOut();
        }
    }
</script>
        ...
        <div class="modal-content">
            ...
            <form name="addNewItem">
                <div class="modal-body">
                    ...
                    <p><em>You will be redirected to add content to this resource.</em></p>
...
<script type="text/javascript">
    jQuery("form[name='addNewItem']").submit(function(e) {
        ...
        jQuery.ajax({
            url: "<?= SITE_URL ?>ajax?c=blumeNew&a=create-resource",
            type: "POST",
            data: formData,
            async: true,
