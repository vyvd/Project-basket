        ...
        <div class="chute chute-center">
            ...
            <div class="row" style="margin-top: -29px;margin-bottom: 17px;">
                ...
                <div class="col-xs-6">
                    ...
                    <a href="<?= SITE_URL ?>blume/support/faqs" class="btn btn-system pull-right" style="margin-left:5px;">Back to FAQ's</a>
...
<script type="text/javascript">
    ...
    jQuery("form[name='edit']").submit(function(e) {
        ...
        jQuery.ajax({
            ...
            url: "<?= SITE_URL ?>ajax?c=blumeNew&a=edit-support-faq",
