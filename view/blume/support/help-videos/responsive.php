    ...
    <div class="chute chute-center">
        ...
        <div class="panel" id="spy2">
            <div class="panel-heading">
                <span class="panel-title">Support Help Videos</span>
            ...
            <div class="panel-body pn">
                <div class="table-responsive">
                    <table class="table footable" data-filter="#fooFilter" data-page-navigation=".pagination" data-page-size="50">
                        ...
                        <tbody>
                        <?php
                        $items = ORM::for_table("supportHelpVideos")->order_by_desc("whenCreated")->find_many();
                        ...
                        foreach($items as $item) {
                            ...
                            <tr id="item<?= $item->id ?>">
                                ...
                                <td>
                                    <a href="javascript:;" data-toggle="modal" data-target="#addNew<?= $item->id ?>" class="label label-warning">
                                        ...
                                        <form name="addNewItem<?= $item->id ?>">
                                            <div class="modal-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="vimeo" class="form-control" value="<?= $item->vimeo ?>" />
                                                </div>
                            ...
                            <script type="text/javascript">
                                jQuery("form[name='addNewItem<?= $item->id ?>']").submit(function(e) {
                                    ...
                                    jQuery.ajax({
                                        url: "<?= SITE_URL ?>ajax?c=blumeNew&a=edit-help-video",
                                        type: "POST",
                                        data: formData,
                                        async: true,
...
<script type="text/javascript">
    function deleteItem(id) {
        if (window.confirm("Are you sure you want to delete this item?")) {
            $("#deleteProduct").load("<?= SITE_URL ?>ajax?c=blumeNew&a=delete-help-video&id="+id);
            $("#item"+id).fadeOut();
        }
    }
</script>
...
<script type="text/javascript">
    jQuery("form[name='addNewItem']").submit(function(e) {
        ...
        jQuery.ajax({
            url: "<?= SITE_URL ?>ajax?c=blumeNew&a=create-help-video",
            type: "POST",
            data: formData,
            async: true,
            success: function (msg) {
